...
class TestValidateSettings:
    ...
    def test_api_root_ends_with_slash(self) -> None:
        ...
        assert settings.api_root == self.test_root, "api_root should have trailing slash removed"
    ...
    def test_api_root_without_trailing_slash(self) -> None:
        ...
        assert settings.api_root == self.test_root, "api_root should remain unchanged"

    def test_api_root_empty_string(self) -> None:
        """Empty string should be handled correctly."""
        settings = Settings(api_root="")
        assert settings.api_root == "", "api_root should handle empty strings correctly"
